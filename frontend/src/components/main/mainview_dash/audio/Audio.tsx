...
const AudioBar = () => {
  ...
  const audioUrl = useCont!.audioUrl
  const setAudioUrl = useCont!.setAudioUrl
  ...
  return (
    <div className="audio-bel-1" id='audio-bel-1'>
      <audio src={audioUrl} controls={true} autoPlay={false} id='audio-001'></audio>
      <div className="main-audio-con">
        ...
        <div className="main-length">
          ...
          <div className="audio-more-1">
            ...
            <input type="range" id="audio-range"min={0} max={duration} className='range-audio' value={currentTime} onChange={handleChange} />
